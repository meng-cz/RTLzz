...
std::optional<pred::v2::TypeInfo> recognizeHwIntType(CXType type);
std::optional<pred::v2::TypeInfo> recognizeBuiltinFixedWidth(CXType type);
std::optional<pred::v2::TypeInfo> recognizeRecordType(CXType type);

std::optional<pred::v2::TypeInfo> recognizeStdArrayType(
    CXType type,
    const std::function<pred::v2::TypeInfo(CXType)>& convert_elem);
